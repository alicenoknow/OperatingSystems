...
void performTest(int size, char* sequance, FILE* fr){
	...
	printf("Create real time: %lfs\n", real[1]);
	printf("Create sys time: %lfs\n", sys[1]);
	printf("Create usr time: %lfs\n\n", usr[1]);
	
	printf("Remove real time: %lfs\n", real[2]);
	printf("Remove sys time: %lfs\n", sys[2]);
	printf("Remove usr time: %lfs\n\n", usr[2]);
	
	printf("Add and Delete real time: %lfs\n", real[3]);
	printf("Add and Delete sys time: %lfs\n", sys[3]);
	printf("Add and Delete usr time: %lfs\n\n", usr[3]);
